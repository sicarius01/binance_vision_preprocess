...
rg_info_map = get_rg_info_map(regime_ft_gen_map, df_train_map[target_symbol], df_test_map[target_symbol], df_evv_train_multi_sb[!, 1:end-0])

df_evv_train_multi_sb[!, "multi_regime_weight_sum"] = calc_multi_regime_based_er_vec(rg_info_map, df_evv_train_multi_sb[!, 1:end-0], "mask_train")
df_evv_test_multi_sb[!, "multi_regime_weight_sum"] = calc_multi_regime_based_er_vec(rg_info_map, df_evv_test_multi_sb[!, 1:end-0], "mask_test")
